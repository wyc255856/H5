...
//        loadFromJsonFile(tracker, "targets.json", "广告图");
//        loadFromJsonFile(tracker, "targets.json", "身份证");
//        loadFromJsonFile(tracker, "targets.json", "方向盘");
...
////                        @Override
////                        public void run() {
////                            if (MainActivity.ar_switch) {
////                                Intent intent=new Intent(MainActivity.context,ResultActivity.class);
////                                intent.putExtra("name",imagetarget.name()+"");
////                                MainActivity.context.startActivity(intent);
////                                Toast.makeText(MainActivity.context, "识别了" + imagetarget.name(), Toast.LENGTH_LONG).show();
////                                MainActivity.ar_switch = false;
////                            }
////
////
////                        }
...
//                        //识别了AR图片显示出遮罩层
//                        if (ManuaARActivity.ar_switch) {
//                            arChangeListener.onShowARImage(imagetarget);
//                            ManuaARActivity.ar_switch = false;
//                            ManuaARActivity.ar_hide_switch = true;
//                        }
//                    }
////
...
//                    if (arChangeListener != null) {
//                        //未识别到图片隐藏遮罩层
//                        if (ManuaARActivity.ar_hide_switch) {
//                            ManuaARActivity.ar_hide_switch=false;
//                            arChangeListener.onHideARImage();
//                            ManuaARActivity.ar_switch = true;
//
//                        }
//                    }
//                }
...
//    }
//
//    public ARChangeListener arChangeListener;
//
//    public void setArChangeListener(ARChangeListener arChangeListener) {
//        this.arChangeListener = arChangeListener;
//    }
//
