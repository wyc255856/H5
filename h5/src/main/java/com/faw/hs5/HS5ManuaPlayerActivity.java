...
public class HS5ManuaPlayerActivity extends HS5BaseActivity {
    ...
    protected void initData() {
        ...
        setContentView(R.layout.hs5_activity_m_player);
        initLoadingDialog();
        LogUtil.logError("HS5SharedpreferencesUtil.getCarMode(this).equals(\"0\") = " + HS5SharedpreferencesUtil.getCarMode(this).equals("0"));
        if (HS5SharedpreferencesUtil.getCarMode(this).equals("1")) {
            showLoadingDialog();
        }
    ...
    protected void initLoadingDialog() {
        loadingDialog = new LoadingDialog(this, R.style.hs5_load_dialog);
