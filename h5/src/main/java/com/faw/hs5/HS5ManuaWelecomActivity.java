...
public class HS5ManuaWelecomActivity extends HS5BaseActivity {
    ...
    protected void initData() {
        ...
        setContentView(R.layout.hs5_activity_welecom);
...
//        if (!isServiceRunning(this, "HS5TargetService")) {
...
//        }
    ...
    private void goNext() {
        ...
        boolean isFirst = HS5SharedpreferencesUtil.getIsFirst(com.faw.hs5.HS5ManuaWelecomActivity.this);
//        if (!isFirst) {
        handler.removeMessages(100001);
        handler.removeMessages(10000);
        if (HS5SharedpreferencesUtil.isGuest(this)) {
            Intent intent = new Intent(com.faw.hs5.HS5ManuaWelecomActivity.this, HS5ManualSelecteCarActivity.class);
            startActivity(intent);
            finish();
        } else {
            Intent intent = new Intent(com.faw.hs5.HS5ManuaWelecomActivity.this, HS5ManualWebActivity.class);
            startActivity(intent);
            HS5SharedpreferencesUtil.setIsFirst(HS5ManuaWelecomActivity.this, false);
            finish();
        }
